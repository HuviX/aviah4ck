...
def app():
    ...
    Сервис позволяет увеличить качество, скорость дефектоскопии и уменьшить издержки производства, при помощи машинного зрения в качестве интеллектуального помощника контролёра.    
    """)
